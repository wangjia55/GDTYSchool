<template>
	<div class="ModeUseData">
		...
		<el-col class="Content" :span="24">
			...
			<img src="http://qiniu.wqdata.net/upload/20190819/603c73c38dea493996ff74aa72f549bc.jpg" />
			<img src="http://qiniu.wqdata.net/upload/20190819/26750bd681764de6841dbe926b1cb986.jpg" />
		</el-col>
		...
		<el-row class="foot">
		  <el-col :span="12"><div class="ChoseMode active" @click="$router.push({path:'/DataReport/ModeUseData/Data'})">
		  	版块使用数据
		  </div></el-col>
...
<script>
	  ...
	  export default {
		    ...
		    watch:{
				title(newVal,oldVal){
					if(newVal=="person"){
						this.$router.push({path:'/DataReport/ModeUseData/DataPerson'})
					}
				},
...
.Content{.IsQuarterShow{text-align: center;padding: 1vh;background: #fff;}
			img{width: 100%;}
		}
		.foot{
