<template>
  <div class="base">
   <div class="btw sale-header">
      <span class="pointleft" @click="toback"></span>
    ...
    <div>
      ...
      <div>
        ...
        <div class="c-con" v-show="kinds==1">
          ...
          <img :src="srcCon[kinds].conSrc" alt />
            <div class="c-c10-1" @click="tops"></div>
          <van-pagination v-model="currentPage" :page-count="12" mode="simple" />
        ...
        <div class="c-con" v-show="kinds==2">
          ...
          <img :src="srcCon[kinds].conSrc" alt />
            <div class="c-c10" @click="tops"></div>
...
export default {
  data() {
    return {
      srcCon: [
        {
          titleSrc: "http://dantong.oss-cn-shenzhen.aliyuncs.com/weiqian/carApp2/%E9%94%80%E5%94%AE%E9%A1%BE%E9%97%AE%E5%88%87%E5%9B%BE/%E8%B6%8B%E5%8A%BF-%E6%80%BB%E9%83%A8-1.jpg",
          conSrc: "http://dantong.oss-cn-shenzhen.aliyuncs.com/weiqian/carApp2/%E9%94%80%E5%94%AE%E9%A1%BE%E9%97%AE%E5%88%87%E5%9B%BE/%E8%B6%8B%E5%8A%BF-%E6%80%BB%E9%83%A8-2.jpg"
        },
         {
          titleSrc: "http://dantong.oss-cn-shenzhen.aliyuncs.com/weiqian/carApp2/%E9%94%80%E5%94%AE%E9%A1%BE%E9%97%AE%E5%88%87%E5%9B%BE/%E8%B6%8B%E5%8A%BF-MAC-1.jpg",
          conSrc: "http://dantong.oss-cn-shenzhen.aliyuncs.com/weiqian/carApp2/%E9%94%80%E5%94%AE%E9%A1%BE%E9%97%AE%E5%88%87%E5%9B%BE/%E8%B6%8B%E5%8A%BF-MAC-2.jpg"
        },
       {
          titleSrc: "http://dantong.oss-cn-shenzhen.aliyuncs.com/weiqian/carApp2/%E9%94%80%E5%94%AE%E9%A1%BE%E9%97%AE%E5%88%87%E5%9B%BE/%E8%B6%8B%E5%8A%BF-%E7%BB%8F%E9%94%80%E5%95%86-1.jpg",
          conSrc: "http://dantong.oss-cn-shenzhen.aliyuncs.com/weiqian/carApp2/%E9%94%80%E5%94%AE%E9%A1%BE%E9%97%AE%E5%88%87%E5%9B%BE/%E8%B6%8B%E5%8A%BF-%E7%BB%8F%E9%94%80%E5%95%86-2.jpg"
        }
      ],
  ...
  mounted(){
    this.kinds = this.$route.params.kind || 0;
    if( this.kinds==0){
      this.hel = "总部"
    ...
    tomap(){
      ...
      if(kinds==0){
        this.$router.push('saleIndex')
         ...
         this.$router.push('saleAreaIndex')
      }else if(kinds==2){
