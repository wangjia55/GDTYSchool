<template>
  ...
  <div class="index-container">
    ...
    <div style="background:#409eff;padding-bottom:40px">
      <div class="init pt20">
        ...
        <div class="top_comment">
          ...
          <div class="news_right">
            <div class="end curpoint" style="font-size:18px">more</div>
            <ul class="news_content color-white">
              <li>
                <a test target="_blank">●&nbsp;&nbsp;国家体育总局关于调整新冠肺炎疫情期间体育行政审批事项办理工作的通知</a>
              </li>
              <li>
                <a test="/index.php/Index/show/id/199.html" target="_blank">
                  ●&nbsp;&nbsp;2020年度广州职业健身“金狮奖”颁奖盛典隆重举行
                  八大荣誉奖项出炉
                </a>
              </li>
              <li>
                <a
                  test="/index.php/Index/show/id/198.html"
                  target="_blank"
                >●&nbsp;&nbsp;2020东方职业健身交流大会年度十佳健身俱乐部、工作室线上报名、评选，火热征集中！</a>
              </li>
              <li>
                <a
                  test="/index.php/Index/show/id/197.html"
                  target="_blank"
                >●&nbsp;&nbsp;广州代表队在2020年全国体育行业职业技能大赛中喜获佳绩</a>
              </li>
              <li>
                <a test="/index.php/Index/show/id/196.html" target="_blank">
                  ●&nbsp;&nbsp;2020“MY
                  COACH”广州市健身教练职业技能大赛顺利收官
                </a>
              </li>
              <!-- <li>
                <a test="/index.php/Index/show/id/195.html" target="_blank">
                  ●&nbsp;&nbsp;【平凡岗位 星耀申城】2020“MY
                  COACH”广州市健身教练职业技能大赛9月开赛
                </a>
              </li>-->
              <li>
                <a test="/index.php/Index/show/id/188.html" target="_blank">
                  ●&nbsp;&nbsp;2020“MY
              ...
              <li>
                <a
                  test="/index.php/Index/show/id/201.html"
                  target="_blank"
    ...
    <!--1.55555555555-->
    <div class="bg-black" style="padding:20px 0">
      <div class="news_detail init pv20" style="margin:0 auto!important;">
        <div class="left" style="border-right:1px solid #ccc">
          <div class="title">
            <p class="news">鉴定公告 &gt;</p>
            <a test="/index.php/Index/category/id/9.html" target="_blank">
              <p class="more curpoint">more</p>
            </a>
          </div>
          <div class="theNews">
            <ul class="news_content color-white">
        ...
        <div class="left space">
          <div class="title">
            <p class="news">培训动态 &gt;</p>
            <a test="/index.php/Index/category/id/2.html" target="_blank">
              <p class="more curpoint">more</p>
            </a>
          </div>
          <div class="theNews">
            <ul class="news_content color-white">
              <li>
                <a
                  test="/index.php/Index/show/id/169.html"
                  target="_blank"
                >●&nbsp;&nbsp;【全国羽毛球教练国职培训班（广州站）】2020年度首期报名</a>
              </li>
              <li>
                <a test="/index.php/Index/show/id/157.html" target="_blank">
                  ●&nbsp;&nbsp;强化新思维
                  构建新体系——“体育经理人培训与测评体系”项目启动
                </a>
              </li>
              <li>
                <a
                  test="/index.php/Index/show/id/156.html"
                  target="_blank"
                >●&nbsp;&nbsp;健身教练国家职业资格培训探索国际接轨新模式</a>
              </li>
              <li>
                <a
                  test="/index.php/Index/show/id/142.html"
                  target="_blank"
                >●&nbsp;&nbsp;《2017年体育职业技能鉴定工作思路和安排》</a>
              </li>
              <li>
                <a
                  test="/index.php/Index/show/id/141.html"
                  target="_blank"
                >●&nbsp;&nbsp;健身指导系列丛书——《我的颈肩我做主》</a>
              </li>
              <li>
                <a
                  test="/index.php/Index/show/id/140.html"
                  target="_blank"
                >●&nbsp;&nbsp;健身指导系列丛书——《办公室也是健身房》</a>
              </li>
            </ul>
    ...
    <div style="background:#409eff;padding:40px 0">
      <div class="init">
        <div class="container-divider">
          <el-divider class>
            <div>项目鉴定</div>
    ...
    <div class="bg-black" style="padding:20px 0">
      <!-- 资格证书 -->
      <div class="init">
        <div class="container-divider-black">资格证书</div>
    ...
    <!-- <div class="init">
      ...
      <div class="project_lead_content" style="background: white;padding: 20px 0">
        <ul class="pic arc">
          <li>
    ...
    <!-- <div class="tools_detail init">
      <div class="left mt20">
        ...
        <div class="thetools jdzn">
          <ul class="thetools arc">
            <li @click="dialogTableVisibleJdzn=true">
              <img src="../../assets/images/icon/pic_1.png" />
              <b>国职证书</b>
            </li>
            <li>
              <img src="../../assets/images/icon/pic_2.png" />
              <b>鉴定机构</b>
            </li>
            <li>
              <img src="../../assets/images/icon/pic_3.png" />
              <b>报考须知</b>
            </li>
            <li>
              <img src="../../assets/images/icon/pic_4.png" />
              <b>政策法规</b>
            </li>
          </ul>
        </div>
      ...
      <div class="right space mt20">
        ...
        <div class="thetools">
          <ul class style="margin: 0 auto;margin-top: 10px;">
            ...
            <li>
              <img src="../../assets/images/bt2.jpg" style="width:300px; border-radius:15px; " />
            </li>
            <li>
              <img src="../../assets/images/bt3.jpg" style="width:300px; border-radius:15px; " />
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="bg-black" style="padding:20px 0 ">
      <div class="init">
        <div class="container-divider-black">
          <div>合作伙伴</div>
        </div>
        <div>
          <div class="flex-wrap partner" style="width:100%;margin:20px auto">
...
.index-container {
  ...
  .top_title {
    width: 100%;
    height: 40px;
    /* background: url(../images/index/top_title.png) no-repeat; */
  ...
  .project_type {
    ...
    .type_line li .statu_1 {
      color: #fff;
    }
    .type_line li .statu_0 {
      color: #fff;
    }
